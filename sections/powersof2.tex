...
\begin{frame}{Idea}
  Otra manera de hacer búsqueda binaria es mediante saltos. Si comenzamos en la posición \texttt{pos=0} y en cada iteración avanzamos mientras \texttt{pos+jump} no salga del arreglo y \texttt{A[pos+jump]} no exceda el valor buscado $x$.\\
